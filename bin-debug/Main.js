...
var Main = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, RES.loadConfig("default.res.json", "http://192.168.1.92/resource/")];
                    case 1:
                        _a.sent();
    ...
    Main.prototype.createGameScene = function () {
        var _this = this;
        RES.getResByUrl("https://resh5.zzcq.lzgame.top/h10//536/536.json", function (data, url) {
            window["verData"] = data;
            _this.loadVerComplete();
    ...
    Main.prototype.loadVerComplete = function () {
